...
import lodeinfo.repository.FileRepository;
...
public class FileController {
    ...
    // DOWNLOAD
    @RequestMapping(
                value = "/news/downloadFile/{id}",
            method = RequestMethod.GET)
    public ResponseEntity downloadFile(@PathVariable Long id) {

        FileEntity fileUpload = fileRepository.findById(id);
    ...
    public ResponseEntity uploadFile(MultipartHttpServletRequest request) {
        ...
        try {
            ...
            while (itr.hasNext()) {
                ...
                FileEntity newFile = new FileEntity(name, mimeType, bytes, newsId, size);
